...
namespace NetProcGame.Game
{
    public class Mode : IMode
    {
        ...
        public void AddSwitchHandler(string Name, string Event_Type, double Delay = 0, SwitchAcceptedHandler Handler = null)
        {
        ...
        public void CancelDelayed(string Name)
        {
        ...
        private void ScanSwitchHandlers()
        {
            ...
            foreach (MethodInfo m in methods)
            {
                ...
                if (switchName != "" && switchState != "")
                {
                    ...
                    AddSwitchHandler(switchName, switchState, switchTime, swh);
                }
            }
        }
