...
namespace NetProcGame.Dmd
{
    ...
    public class DisplayController
    {
        ...
        public DisplayController(IGameController game, int width = 128, int height = 32, Font message_font = null)
        {
            this.game = game;
            this.width = width;
            this.height = height;
            ...
            this.frame_handlers.Add(new DMDFrameHandler(game.PROC.DmdDraw));
        }
